        ...
        <div className="pt-[40px] md:pt-[130px] pb-[40px] px-[16px]">
          <section className="mx-auto text-black my-[24px] w-full max-w-[1100px] md:mt-[16px] lg:mt-[15px]">
            ...
            <div className="w-full">
              <h2 className="text-[#424242] font-[900] text-[29.35px] font-poly tracking-[0.02em] mt-[54px] mb-[16px] lg:ml-[15px] selection:bg-[#B4D5FF] leading-[1.35] sm:leading-normal">
