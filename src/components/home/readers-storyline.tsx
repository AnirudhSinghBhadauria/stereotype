    ...
    <div>
      <section className="relative pl-[38px] font-poly lg:pl-[50px]">
        <div>
          ...
          <p className="uppercase primary-small-torq-11px mb-[1.35px] text-[#949494] tracking-[0.15em]">
            {`feed refreshed as per ${date}`}
          </p>
          <p className="uppercase primary-small-torq-11px leading-[1.4] tracking-[0.15em] pb-[24px]">
            {message}
          </p>
