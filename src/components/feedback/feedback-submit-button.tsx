  ...
  return (
    <Fragment>
      <button
        ...
        disabled={pending}
      >
        <p className="transition-all duration-300 translate-y-[-1.2px]">
      ...
      >
        <p className="translate-y-[-1.2px]">
          Success!&nbsp; We got your feedback, Thank you.
        </p>
...
<button
  style={{ display: submitButtonStatus }}
  className="transition-all duration-300 flex flex-row justify-center items-center rounded-[5px] font-gen text-[14px] tracking-wide font-medium py-[8px] pl-[32px] pr-[32px] bg-black text-white space-x-16 mt-[32px] disabled:opacity-60"
  type="submit"
  disabled={pending}
>
  <p className="transition-all duration-300 translate-y-[-1.2px]">
